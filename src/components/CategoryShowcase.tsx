...
const categories = [
  {
    ...
    image:
      "https://images.unsplash.com/photo-1512621776951-a57141f2eefd?q=60&w=600&auto=format&fit=crop",
    theme: "text-[var(--jade)]",
  },
  {
    id: "milk",
    ...
    image:
      "https://images.unsplash.com/photo-1550583724-b2692b85b150?q=60&w=600&auto=format&fit=crop",
    theme: "text-blue-200",
  },
  {
    id: "fish",
    ...
    image:
      "https://images.unsplash.com/photo-1615141982883-c7ad0e69fd62?q=60&w=600&auto=format&fit=crop",
    theme: "text-cyan-200",
  },
  {
    id: "meat",
    ...
    image:
      "https://images.unsplash.com/photo-1529692236671-f1f6cf9683ba?q=60&w=600&auto=format&fit=crop",
    theme: "text-rose-300",
  },
  {
    id: "groceries",
      ...
      <div className="sticky top-0 flex h-screen items-center overflow-hidden">
        <motion.div style={{ x }} className="flex w-[500vw] h-full will-change-transform">
          {categories.map((category, index) => (
            <div
              key={category.id}
              className="relative flex h-full w-[100vw] items-center justify-center p-6 md:p-24"
            >
              ...
              <div className="relative z-10 grid h-full w-full max-w-[1400px] grid-cols-1 items-end pb-20 md:grid-cols-2 md:items-center md:pb-0">
                <div className="flex flex-col justify-end">
                  ...
                  <h2
                    className={`font-display text-[clamp(3.5rem,8vw,8rem)] leading-[0.9] tracking-[-0.03em] ${category.theme}`}
                  >
                    {category.title}
                  </h2>
