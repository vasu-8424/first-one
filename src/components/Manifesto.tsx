...
export function Manifesto() {
  ...
  return (
    <section
      id="experience"
      ref={ref}
      className="relative py-36 md:py-48 overflow-hidden bg-background"
    >
      ...
      <div className="pointer-events-none absolute inset-0 z-0 opacity-20 md:opacity-30 will-change-transform">
        {[
          {
            url: "https://images.unsplash.com/photo-1560806887-1e4cd0b6cb6c?q=80&w=200&auto=format&fit=crop",
            top: "10%",
            left: "15%",
            depth: 50,
            delay: 0,
          ...
          {
            url: "https://images.unsplash.com/photo-1592924357228-91a4daadcfea?q=80&w=200&auto=format&fit=crop",
            top: "60%",
            left: "10%",
            depth: -30,
            delay: 1,
          ...
          {
            url: "https://images.unsplash.com/photo-1509440159596-0249088772ff?q=80&w=200&auto=format&fit=crop",
            top: "20%",
            right: "15%",
            depth: 40,
            delay: 2,
          ...
          {
            url: "https://images.unsplash.com/photo-1528821128474-27f963b062bf?q=80&w=200&auto=format&fit=crop",
            top: "70%",
            right: "12%",
            depth: -60,
            delay: 3,
          ...
          {
            url: "https://images.unsplash.com/photo-1556910103-1c02745aae4f?q=80&w=200&auto=format&fit=crop",
            top: "40%",
            right: "25%",
            depth: 80,
            delay: 1.5,
            special: "cold-protected,",
          },
          {
...
function ScrollWord({
  ...
  return (
    <motion.span
      ...
      className={`mr-[0.28em] inline-block ${isHighlight ? "italic" : ""}`}
    >
      {text}
    </motion.span>
  );
